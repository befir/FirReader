...
public class VideoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MediaController mMediaController = new MediaController(videoView.getContext());
        VideoDto.ChapterDto video = (VideoDto.ChapterDto) this.getIntent().getSerializableExtra("chapter");
        videoView.setMediaController(mMediaController);
        videoView.setVideoURI(Uri.parse(video.getChapterUrl()));
        getWindow().addFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN);
        videoView.setLayoutParams(new ConstraintLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT,LinearLayout.LayoutParams.MATCH_PARENT));
        videoView.start();
